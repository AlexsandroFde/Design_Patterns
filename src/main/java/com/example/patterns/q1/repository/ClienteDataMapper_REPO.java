...
public class ClienteDataMapper_REPO {

    public Cliente_DM_REPO fromMap(Map<String, Object> m) {
        if (m == null)
            return null;
        Cliente_DM_REPO c = new Cliente_DM_REPO();
    ...
    public Map<String, Object> toMap(Cliente_DM_REPO c) {
